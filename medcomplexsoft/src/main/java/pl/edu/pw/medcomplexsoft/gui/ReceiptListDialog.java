 ...
 * @author hubert
 */
public class ReceiptListDialog extends javax.swing.JDialog {

    /**
     * Creates new form ReceiptListDialog
     */
    public ReceiptListDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiptListDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReceiptListDialog dialog = new ReceiptListDialog(new javax.swing.JFrame(), true);
